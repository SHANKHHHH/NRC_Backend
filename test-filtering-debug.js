...
async function testFilteringDebug() {
  try {
    console.log('🔍 Testing filtering with debug logging...');
    ...
    // 2. Test the jobs endpoint and check server logs
    console.log('\n2. Testing jobs endpoint (check server logs for debug output)...');
    try {
