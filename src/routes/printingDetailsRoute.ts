...
import { createPrintingDetails, getPrintingDetailsById, getPrintingDetailsByJobStepId, getAllPrintingDetails, updatePrintingDetails, updatePrintingDetailsByStepId, deletePrintingDetails, getPrintingDetailsByNrcJobNo, updatePrintingDetailsStatus } from '../controllers/printingDetailsController';
...
router.put('/by-step-id/:jobStepId', authenticateToken, asyncHandler(updatePrintingDetailsByStepId));
