...
import { createQualityDept, getQualityDeptById, getQualityDeptByJobStepId, getAllQualityDepts, updateQualityDept, updateQualityDeptByStepId, deleteQualityDept, getQualityDeptByNrcJobNo, updateQualityDeptStatus, holdQualityDept, resumeQualityDept, startQualityWork } from '../controllers/qualityDeptController';
...
router.put('/by-step-id/:jobStepId', authenticateToken, asyncHandler(updateQualityDeptByStepId));
