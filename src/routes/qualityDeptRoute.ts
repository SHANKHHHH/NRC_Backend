...
import { createQualityDept, getQualityDeptById, getAllQualityDepts, updateQualityDept, deleteQualityDept, getQualityDeptByNrcJobNo, updateQualityDeptStatus } from '../controllers/qualityDeptController';
