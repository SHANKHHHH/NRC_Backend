...
import { createCorrugation, getCorrugationById, getCorrugationByJobStepId, getAllCorrugations, updateCorrugation, updateCorrugationByStepId, deleteCorrugation, getCorrugationByNrcJobNo, updateCorrugationStatus } from '../controllers/corrugationController';
...
router.put('/by-step-id/:jobStepId', authenticateToken, asyncHandler(updateCorrugationByStepId));
