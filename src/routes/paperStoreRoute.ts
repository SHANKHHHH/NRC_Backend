...
import { createPaperStore, getPaperStoreById, getPaperStoreByJobStepId, getAllPaperStores, updatePaperStore, updatePaperStoreByStepId, deletePaperStore, getPaperStoreByNrcJobNo, updatePaperStoreStatus, holdPaperStore, resumePaperStore, startPaperStoreWork } from '../controllers/paperStoreController';
...
router.put('/by-step-id/:jobStepId', authenticateToken, asyncHandler(updatePaperStoreByStepId));
