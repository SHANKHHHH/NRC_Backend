...
async function checkKanCorrugation() {
  try {
    console.log('🔍 Checking Corrugation records for KAN-0 SIZE PAPER BAG...');
    ...
    const corrugationResponse = await axios.get(`${BASE_URL}/corrugation/by-job/KAN-0 SIZE PAPER BAG`, {
